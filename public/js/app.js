...
document.addEventListener('DOMContentLoaded', function () {
    ...
    $('#produit-table').DataTable({
        paging: false,          // Désactiver la pagination DataTables (vous utilisez déjà KnpPaginator)
        info: false,            // Masquer les infos "Showing X to Y of Z entries"
        searching: false,       // Désactiver la recherche DataTables (vous avez déjà votre propre recherche)
